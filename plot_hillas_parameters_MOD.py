...
if __name__ == '__main__':
    ...
    source = EventSourceFactory.produce(input_url="/scratch/bernardos/LST1/gamma_20deg_180deg_run2201___cta-prod3-demo-2147m-LaPalma-demo3-FC_cone8.simtel.gz",allowed_tels={1});
